...
from base b
left join revenue r
    on b.metric_date = r.metric_date and b.branch_id = r.branch_id
left join inventory i
    on b.metric_date = i.metric_date and b.branch_id = i.branch_id
left join labor l
    on b.metric_date = l.metric_date and b.branch_id = l.branch_id
left join operational o
    on b.metric_date = o.metric_date and b.branch_id = o.branch_id
left join {{ ref('dim_branches') }} d
