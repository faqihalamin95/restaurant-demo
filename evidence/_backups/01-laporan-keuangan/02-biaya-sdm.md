      ...
      <div class="clean-cta-banner">
        <div class="clean-cta-content">
          ...
          <div class="clean-cta-text">
            <h3 class="clean-cta-title">Investigasi Kebocoran Biaya SDM</h3>
            <p class="clean-cta-desc">Periksa peringkat staf dengan beban lembur tertinggi (Risiko Burnout) dan telusuri rapor jadwal individu di Direktori Pegawai.</p>
          </div>
        </div>
        <a href="/07-employee-performance/05-direktori-data" class="clean-cta-button">
          Buka Direktori Data Pegawai ➔
        </a>
      </div>
