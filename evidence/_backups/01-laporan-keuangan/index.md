    ...
    <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 20px; padding: 24px; background: rgba(13, 148, 136, 0.04); border: 1px solid rgba(13, 148, 136, 0.15); border-radius: 16px;">
      ...
      <div class="chart-insight-bar">
        📌 <strong>Kalkulasi Target:</strong> Target akhir bulan dihitung secara otomatis berdasarkan rata-rata pendapatan kotor dari 3 bulan penuh terakhir.
            ...
            <div class="cost-grid">
              <div class="cost-card" style="background: {fin_cost_pct[0].bahan_30d <= 30 ? 'linear-gradient(180deg, rgba(240,253,244,0.9), rgba(220,252,231,0.6))' : fin_cost_pct[0].bahan_30d <= 35 ? 'linear-gradient(180deg, rgba(254,252,232,0.9), rgba(254,249,195,0.6))' : 'linear-gradient(180deg, rgba(254,242,242,0.9), rgba(254,226,226,0.6))'}; border-color: {fin_cost_pct[0].bahan_30d <= 30 ? 'rgba(34,197,94,0.5)' : fin_cost_pct[0].bahan_30d <= 35 ? 'rgba(234,179,8,0.5)' : 'rgba(239,68,68,0.5)'};">
                <div class="cost-label">🥩 Biaya Bahan</div>
                <div class="cost-value" style="color:{fin_cost_pct[0].bahan_30d > 30 ? '#dc2626' : '#16a34a'};">{fin_cost_pct[0].bahan_30d}%</div>
                <div class="cost-target">🎯 Target normal maks 30%</div>
                <div class="progress-track">
                  <div class="progress-fill" style="width:{Math.min(fin_cost_pct[0].bahan_30d / 40 * 100, 100)}%; background:{fin_cost_pct[0].bahan_30d > 30 ? 'linear-gradient(90deg,#ef4444,#fca5a5)' : 'linear-gradient(90deg,#16a34a,#86efac)'};"></div>
                  <div class="progress-target" style="left:{30 / 40 * 100}%;"></div>
                </div>
                <div class="progress-scale"><span>0%</span><span>30%</span><span>40%</span></div>
                <a href="/01-laporan-keuangan/01-biaya-bahan" class="cost-cta">Bedah Rincian ➔</a>
                <div class="cost-note">
                  <div>
              ...
              <div class="cost-card" style="background: {fin_cost_pct[0].sdm_30d <= 30 ? 'linear-gradient(180deg, rgba(240,253,244,0.9), rgba(220,252,231,0.6))' : fin_cost_pct[0].sdm_30d <= 35 ? 'linear-gradient(180deg, rgba(254,252,232,0.9), rgba(254,249,195,0.6))' : 'linear-gradient(180deg, rgba(254,242,242,0.9), rgba(254,226,226,0.6))'}; border-color: {fin_cost_pct[0].sdm_30d <= 30 ? 'rgba(34,197,94,0.5)' : fin_cost_pct[0].sdm_30d <= 35 ? 'rgba(234,179,8,0.5)' : 'rgba(239,68,68,0.5)'};">
                <div class="cost-label">👥 Biaya SDM</div>
                <div class="cost-value" style="color:{fin_cost_pct[0].sdm_30d > 30 ? '#f59e0b' : '#16a34a'};">{fin_cost_pct[0].sdm_30d}%</div>
                <div class="cost-target">🎯 Target normal maks 30%</div>
                <div class="progress-track">
                  <div class="progress-fill" style="width:{Math.min(fin_cost_pct[0].sdm_30d / 35 * 100, 100)}%; background:{fin_cost_pct[0].sdm_30d > 30 ? 'linear-gradient(90deg,#f59e0b,#fde68a)' : 'linear-gradient(90deg,#16a34a,#86efac)'};"></div>
                  <div class="progress-target" style="left:{30 / 35 * 100}%;"></div>
                </div>
                <div class="progress-scale"><span>0%</span><span>30%</span><span>35%</span></div>
                <a href="/01-laporan-keuangan/02-biaya-sdm" class="cost-cta">Bedah Rincian ➔</a>
                <div class="cost-note">
                  <div>
              ...
              <div class="cost-card" style="background: {fin_cost_pct[0].ops_30d <= 30 ? 'linear-gradient(180deg, rgba(240,253,244,0.9), rgba(220,252,231,0.6))' : fin_cost_pct[0].ops_30d <= 35 ? 'linear-gradient(180deg, rgba(254,252,232,0.9), rgba(254,249,195,0.6))' : 'linear-gradient(180deg, rgba(254,242,242,0.9), rgba(254,226,226,0.6))'}; border-color: {fin_cost_pct[0].ops_30d <= 30 ? 'rgba(34,197,94,0.5)' : fin_cost_pct[0].ops_30d <= 35 ? 'rgba(234,179,8,0.5)' : 'rgba(239,68,68,0.5)'};">
                <div class="cost-label">⚙️ Biaya Operasional</div>
                <div class="cost-value" style="color:{fin_cost_pct[0].ops_30d > 35 ? '#dc2626' : (fin_cost_pct[0].ops_30d > 30 ? '#ea580c' : '#16a34a')};">{fin_cost_pct[0].ops_30d}%</div>
                <div class="cost-target">🎯 Target normal maks 30%</div>
                <div class="progress-track">
                  <div class="progress-fill" style="width:{Math.min(fin_cost_pct[0].ops_30d / 40 * 100, 100)}%; background:{fin_cost_pct[0].ops_30d > 35 ? 'linear-gradient(90deg,#ef4444,#fca5a5)' : 'linear-gradient(90deg,#16a34a,#86efac)'};"></div>
                  <div class="progress-target" style="left:{30 / 40 * 100}%;"></div>
                </div>
                <div class="progress-scale"><span>0%</span><span>30%</span><span>40%</span></div>
                <a href="/01-laporan-keuangan/03-biaya-operasional" class="cost-cta">Bedah Rincian ➔</a>
                <div class="cost-note">
                  <div>
