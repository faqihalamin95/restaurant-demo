...
<div class="evidence-tabs-container">
  ...
  <a href="/03-inventori-stok/overstock" class="tab-button active">📦 Overstock</a>
...
{#if inv_overstock_items.length > 0}
<div class="inv-page">
  ...
  <details class="context-acc" open>
    ...
    <div class="acc-body">
      ...
      <ul>
        <li><strong>Sangat Berlebih (days_remaining &gt;= 30 hari)</strong>: Modal tertahan sangat lama. Tahan PO baru atau pindahkan ke cabang lain.</li>
        <li><strong>Berlebih Tinggi (days_remaining &gt;= 21 hari)</strong>: Penumpukan cukup tinggi, evaluasi jadwal pemesanan.</li>
        <li><strong>Berlebih (days_remaining &gt; 14 hari)</strong>: Di atas batas aman standar (14 hari). Pantau pemakaian.</li>
      </ul>
      <strong>Estimasi Idle Value</strong> adalah perkiraan nilai stok yang mengendap melebihi batas 14 hari aman.
    </div>
  </details>
  ...
  <div class="section-card" style="margin-top: 16px;">
    ...
    <DataTable data={inv_overstock_items} search=true rows=10>
      ...
      <Column id="overstock_status" title="Status" />
    </DataTable>
  </div>
  ...
  <div class="section-card" style="margin-top: 16px;">
    ...
    <BarChart data={inv_stock_value_by_category} x="category" y={["stock_value", "overstock_value"]} type="grouped" title="Nilai Stok vs Overstock per Kategori" yFmt="#,##0" xAxisTitle="Kategori" yAxisTitle="Nilai (Rp)" />
  </div>
